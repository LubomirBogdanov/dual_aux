...
"\nWrong command!\n" is returned.  
After channel selection, a 3-second timeout is implemented, then the selected channel  
number is saved in EEPROM. This makes the device to return the string "\nSaving in EEPROM ...\n".  
